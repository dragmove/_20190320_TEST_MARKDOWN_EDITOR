...
ParserBlock.prototype.tokenize = function(state, startLine, endLine) {
  ...
  // console.log("parser_block - state after tokenize :", state);
};
...
ParserBlock.prototype.parse = function(src, md, env, outTokens) {
  // console.log("ParserBlock.prototype.parse :", src, md, env, outTokens);
  var state;

  if (!src) return;

  state = new this.State(src, md, env, outTokens);
  // console.log("state_block :", state);
